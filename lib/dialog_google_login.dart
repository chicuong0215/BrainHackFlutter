...
class DialogGoogleLogin extends StatefulWidget {
  const DialogGoogleLogin({super.key});
...
class _DialogGoogleLogin extends State<DialogGoogleLogin> {
  ...
  Widget edtEmail = TextField(
    ...
    decoration: InputDecoration(
      filled: true,
      fillColor: const Color(0xFFFFC7A4),
  ...
  Widget btnLogin = ElevatedButton(
    style: ElevatedButton.styleFrom(
      backgroundColor: const Color(0xFFFA6000),
